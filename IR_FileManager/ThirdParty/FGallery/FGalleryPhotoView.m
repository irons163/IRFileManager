...
@synthesize imageView, thumbView;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    thumbView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, frame.size.height)];
...
- (void)setFrame:(CGRect)theFrame
{
    ...
    CGPoint imagePoint = mainView.frame.origin;
	...
	// resize view and keep it proportional to the current zoom scale
    mainView.frame = CGRectMake( imagePoint.x, imagePoint.y, theFrame.size.width * self.zoomScale, theFrame.size.height * self.zoomScale);
