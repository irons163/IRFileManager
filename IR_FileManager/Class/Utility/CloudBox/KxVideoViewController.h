...
@interface KxVideoViewController : UIViewController<UITableViewDataSource, UITableViewDelegate, BJRangeSliderWithProgressDelegate, StaticHttpRequestDelegate, KxVideoDelegate>{
