...
static NSString *m_recordingPath;
static NSString *m_aviTmpPath;
static NSInteger m_CurrentOSVersion;
static const int FROM_NET = 0;
static const int FROM_LOCAL = 1;
