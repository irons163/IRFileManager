...
- (void)openFormatContext
{
    ...
    if ([self.delegate respondsToSelector:@selector(decoderDidPrepareToDecodeFrames:a:)]) {
        [self.delegate decoderDidPrepareToDecodeFrames:self a:self.formatContext->_video_codec_context->codec_id];
    }
